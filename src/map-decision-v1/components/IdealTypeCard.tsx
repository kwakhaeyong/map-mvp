...
// 필수 30문항만 답하고 결과를 본 사람에게 "8개 더 답하기"를 안내한다.
  ...
  return (
    <Card className="flex flex-col gap-3 text-sm">
      <p className="font-extrabold text-text-primary">
        이 결과는 30개 답변으로 만들었어요. 8개를 더 답하면 앞으로 어떤 사람에게 끌릴지 전망하거나, 예전과 달라진 점을 짚어주는 통찰이 추가돼요.
      </p>
...
function IdealTypeCardBody({
  ...
  // 아니라 심화 문항 시작 지점으로 곧장 이동한다. 필수 30문항 답변은
