...
// 톤은 유지했다 — 기존 6개 중 5개가 쓰던 "~까요?" 높임 어미로
// 통일해서 사이트 전반의 해요체와도 맞췄다. selfIntro만 예외로
// 평서형에 가까운 "~다면?" 어미를 쓴다 — "네 글자"는 MBTI(4글자
// 유형 코드)를 가리키는 은근한 대구로, 위 헤드라인("16개 유형에
// 넣지 않아요")의 포지셔닝과 이어진다.
const TOPIC_HOOK: Record<string, string> = {
  idealType: "나는 왜 비슷한 사람에게 끌릴까요?",
  selfIntro: "나를 네 글자로 줄일 수 없다면?",
  friendship: "요즘 왜 사람 만나는 게 피곤할까요?",
  work: "나는 일할 때 어떤 사람일까요?",
  taste: "나도 모르는 내 취향은?",
  travelStyle: "나는 여행에서 어떤 사람이 될까요?",
