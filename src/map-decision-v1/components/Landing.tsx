    ...
    <main className="min-h-screen overflow-x-hidden bg-[#fbf7ef] px-4 py-4 text-slate-950 sm:px-6 lg:px-8">
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-10 py-12 sm:py-16 lg:grid-cols-[minmax(0,0.92fr)_minmax(26rem,1.08fr)] lg:gap-14 lg:py-20">
        <div className="min-w-0 max-w-2xl">
          <p className="inline-flex max-w-full rounded-full bg-white px-4 py-2 text-xs font-black leading-5 text-blue-700 shadow-sm sm:text-sm">로그인 없이 바로 시작 · 첫 MAP까지 약 5분 · 작성 중 자동 저장 · 언제든 이어서 수정 가능</p>
          ...
          <p className="mt-5 max-w-xl whitespace-pre-line break-keep text-base font-semibold leading-8 text-slate-600 sm:text-lg">편하게 말하거나 입력해 주세요.{`\n`}생각의 핵심과 선택지, 걸리는 부분과 다음 행동을 한 장의 MAP으로 정리해드려요.</p>
