// 취향의 1080×1350 초대장 컨셉 card.png satori 렌더링 로직.
// work-card-image.tsx와 완전히 같은 구조다 — 이상형(ideal-type-
...
// work-card-image.tsx의 같은 상수 옆 주석 참고(다섯 파일이 같은
...
// ideal-type-card-image.tsx/work-card-image.tsx의 TopicLabel과 같은
// 이유·같은 크기(30px, textSecondary)로 추가한다 — 다섯 카드가 태그를
...
// 담는다(이상형·나 소개·친구·인간관계·일할 때의 나의 초대장 카드와
// 동일한 범위 — 자기성찰 텍스트는 카드에 넣지 않는다).
export function buildTasteCardElement(result: TasteResult) {
