// 일할 때의 나의 1080×1350 초대장 컨셉 card.png satori 렌더링 로직.
// friendship-card-image.tsx와 완전히 같은 구조다 — 이상형(ideal-type-
...
// ideal-type-card-image.tsx/friendship-card-image.tsx의 TopicLabel과
// 같은 이유·같은 크기(30px, textSecondary)로 추가한다 — 네 카드가
