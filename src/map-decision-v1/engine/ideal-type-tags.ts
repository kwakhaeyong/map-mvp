...
//
// 정확히 4개 축, 총 32개 태그(카테고리별 매핑 항목 합) — 정의된 축은
...
type TagTopicId = "idealType" | "selfIntro" | "friendship";
type TagCategory = {
  id: string;
  label: string;
...
export const TAG_CATEGORIES: TagCategory[] = [
  {
    ...
    axisId: { idealType: "relationship", selfIntro: "relationship", friendship: "friendRole" },
    mapping: {
  ...
  },
  {
    ...
    axisId: { idealType: "idealStressResponse", selfIntro: "experienceStressResponse", friendship: "experienceStressResponse" },
    mapping: {
  ...
  },
  {
    ...
    axisId: { idealType: "binary1", selfIntro: "binary1", friendship: "friendDistance" },
    mapping: {
...
// 경우(이론상 지금은 없다 — 4개 카테고리 전부 세 주제 모두에 axisId가
