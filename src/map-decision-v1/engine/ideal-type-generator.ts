...
- 필수 12문항만 답해 경험·행동형 답변이 3개뿐인 경우에는 예측·변화·교차 문장을 쓰지 마라 — 근거 없는 추측이 된다. 지금 있는 답변만으로 확인 가능한 해석에 머물러라.
