      ...
      <article className="map-container max-w-3xl">
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="break-keep leading-7 text-text-secondary">
            ...
            카드는 만들어진 결과를 서버에 최대 30분간 임시로 저장합니다 —
            자세한 내용은 3번 항목을 참고하세요.
          </p>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="break-keep leading-7 text-text-secondary">
            그 밖에, 이상형, 나 소개, 친구·인간관계, 일할 때의 나 카드는
            결과를 만드는 동안 &ldquo;공유하기&rdquo;를
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="break-keep leading-7 text-text-secondary">
            이상형, 나 소개, 친구·인간관계, 일할 때의 나 카드의 생성 결과
            임시 저장(3번 항목 참고)은
        ...
        <p className="mt-10 text-xs font-semibold text-text-muted">
          시행일: 2026-08-03
          <br />
          최근 개정일: 2026-08-06 (1·3·5항의 주제 나열에 새로 추가된 &ldquo;일할 때의 나&rdquo;를 반영)
        </p>
      </article>
    </main>
  );
