      ...
      <article className="map-container max-w-3xl">
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="break-keep leading-7 text-text-secondary">
            ...
            취향, 여행 스타일 카드는 만들어진 결과를 서버에 최대 30분간
            임시로 저장합니다 — 자세한 내용은 3번 항목을 참고하세요.
          </p>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="break-keep leading-7 text-text-secondary">
            ...
            여행 스타일 카드는 결과를 만드는 동안 &ldquo;공유하기&rdquo;를
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="break-keep leading-7 text-text-secondary">
            이상형, 나 소개, 친구·인간관계, 일할 때의 나, 취향, 여행
            스타일 카드의 생성 결과 임시 저장(3번 항목 참고)은
