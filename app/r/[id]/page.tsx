...
import { FinalResult, FriendshipResult, IdealTypeResult, SelfIntroResult, WorkResult } from "../../../src/map-decision-v1/types";
...
export default async function SharedResultPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const isInvitationBackground =
    renderable?.kind === "idealType" || renderable?.kind === "selfIntro" || renderable?.kind === "friendship" || renderable?.kind === "work";
